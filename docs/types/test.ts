...
// The function returns a function...
{
	...
	resolveSetter( new Float16Array( 0 ) ); // $ExpectType SetFloat16
...
// The function returns a function which sets an array element...
{
	...
	set11( x11, 2, 10 ); // $ExpectType void

	const x12 = new Complex128Array( [ 1, 2, 3, 4 ] );
	const set12 = resolveSetter( x12 );
	set12( x12, 0, new Complex128( 5, 6 ) ); // $ExpectType void

	const x13 = new Complex64Array( [ 1, 2, 3, 4 ] );
	const set13 = resolveSetter( x13 );
	set13( x13, 0, new Complex64( 5, 6 ) ); // $ExpectType void

	const x14 = new AccessorArray( [ 1, 2, 3, 4 ] );
	const set14 = resolveSetter( x14 );
	set14( x14, 2, 10 ); // $ExpectType void
}
...
// The compiler throws an error if the returned function is provided a first argument which is not a collection...
{
	...
	const set4 = resolveSetter( new Float16Array( 0 ) );
	...
	const set5 = resolveSetter( new Int32Array( 0 ) );
	...
	const set6 = resolveSetter( new Int16Array( 0 ) );
	...
	const set7 = resolveSetter( new Int8Array( 0 ) );
	...
	const set8 = resolveSetter( new Uint32Array( 0 ) );
	...
	const set9 = resolveSetter( new Uint16Array( 0 ) );
	...
	const set10 = resolveSetter( new Uint8Array( 0 ) );
	...
	const set11 = resolveSetter( new Uint8ClampedArray( 0 ) );
	set11( 5, 2, 10 ); // $ExpectError
	set11( true, 2, 10 ); // $ExpectError
	set11( false, 2, 10 ); // $ExpectError
	set11( null, 2, 10 ); // $ExpectError
	set11( {}, 2, 10 ); // $ExpectError

	const set12 = resolveSetter( new Complex128Array( 0 ) );
	set12( 5, 2, new Complex128( 0, 0 ) ); // $ExpectError
	set12( true, 2, new Complex128( 0, 0 ) ); // $ExpectError
	set12( false, 2, new Complex128( 0, 0 ) ); // $ExpectError
	set12( null, 2, new Complex128( 0, 0 ) ); // $ExpectError
	set12( {}, 2, new Complex128( 0, 0 ) ); // $ExpectError

	const set13 = resolveSetter( new Complex64Array( 0 ) );
	set13( 5, 2, new Complex64( 0, 0 ) ); // $ExpectError
	set13( true, 2, new Complex64( 0, 0 ) ); // $ExpectError
	set13( false, 2, new Complex64( 0, 0 ) ); // $ExpectError
	set13( null, 2, new Complex64( 0, 0 ) ); // $ExpectError
	set13( {}, 2, new Complex64( 0, 0 ) ); // $ExpectError

	const set14 = resolveSetter( new AccessorArray( [ 1, 2, 3, 4 ] ) );
	set14( 5, 2, 10 ); // $ExpectError
	set14( true, 2, 10 ); // $ExpectError
	set14( false, 2, 10 ); // $ExpectError
	set14( null, 2, 10 ); // $ExpectError
	set14( {}, 2, 10 ); // $ExpectError
}
...
// The compiler throws an error if the returned function is provided a second argument which is not a number...
{
	...
	const set4 = resolveSetter( new Float16Array( 0 ) );
	set4( new Float16Array( [ 1, 2, 3, 4 ] ), '5', 10 ); // $ExpectError
	set4( new Float16Array( [ 1, 2, 3, 4 ] ), true, 10 ); // $ExpectError
	set4( new Float16Array( [ 1, 2, 3, 4 ] ), false, 10 ); // $ExpectError
	set4( new Float16Array( [ 1, 2, 3, 4 ] ), null, 10 ); // $ExpectError
	set4( new Float16Array( [ 1, 2, 3, 4 ] ), {}, 10 ); // $ExpectError

	const set5 = resolveSetter( new Int32Array( 0 ) );
	set5( new Int32Array( [ 1, 2, 3, 4 ] ), '5', 10 ); // $ExpectError
	set5( new Int32Array( [ 1, 2, 3, 4 ] ), true, 10 ); // $ExpectError
	set5( new Int32Array( [ 1, 2, 3, 4 ] ), false, 10 ); // $ExpectError
	set5( new Int32Array( [ 1, 2, 3, 4 ] ), null, 10 ); // $ExpectError
	set5( new Int32Array( [ 1, 2, 3, 4 ] ), {}, 10 ); // $ExpectError

	const set6 = resolveSetter( new Int16Array( 0 ) );
	set6( new Int16Array( [ 1, 2, 3, 4 ] ), '5', 10 ); // $ExpectError
	set6( new Int16Array( [ 1, 2, 3, 4 ] ), true, 10 ); // $ExpectError
	set6( new Int16Array( [ 1, 2, 3, 4 ] ), false, 10 ); // $ExpectError
	set6( new Int16Array( [ 1, 2, 3, 4 ] ), null, 10 ); // $ExpectError
	set6( new Int16Array( [ 1, 2, 3, 4 ] ), {}, 10 ); // $ExpectError

	const set7 = resolveSetter( new Int8Array( 0 ) );
	set7( new Int8Array( [ 1, 2, 3, 4 ] ), '5', 10 ); // $ExpectError
	set7( new Int8Array( [ 1, 2, 3, 4 ] ), true, 10 ); // $ExpectError
	set7( new Int8Array( [ 1, 2, 3, 4 ] ), false, 10 ); // $ExpectError
	set7( new Int8Array( [ 1, 2, 3, 4 ] ), null, 10 ); // $ExpectError
	set7( new Int8Array( [ 1, 2, 3, 4 ] ), {}, 10 ); // $ExpectError

	const set8 = resolveSetter( new Uint32Array( 0 ) );
	set8( new Uint32Array( [ 1, 2, 3, 4 ] ), '5', 10 ); // $ExpectError
	set8( new Uint32Array( [ 1, 2, 3, 4 ] ), true, 10 ); // $ExpectError
	set8( new Uint32Array( [ 1, 2, 3, 4 ] ), false, 10 ); // $ExpectError
	set8( new Uint32Array( [ 1, 2, 3, 4 ] ), null, 10 ); // $ExpectError
	set8( new Uint32Array( [ 1, 2, 3, 4 ] ), {}, 10 ); // $ExpectError

	const set9 = resolveSetter( new Uint16Array( 0 ) );
	set9( new Uint16Array( [ 1, 2, 3, 4 ] ), '5', 10 ); // $ExpectError
	set9( new Uint16Array( [ 1, 2, 3, 4 ] ), true, 10 ); // $ExpectError
	set9( new Uint16Array( [ 1, 2, 3, 4 ] ), false, 10 ); // $ExpectError
	set9( new Uint16Array( [ 1, 2, 3, 4 ] ), null, 10 ); // $ExpectError
	set9( new Uint16Array( [ 1, 2, 3, 4 ] ), {}, 10 ); // $ExpectError

	const set10 = resolveSetter( new Uint8Array( 0 ) );
	set10( new Uint8Array( [ 1, 2, 3, 4 ] ), '5', 10 ); // $ExpectError
	set10( new Uint8Array( [ 1, 2, 3, 4 ] ), true, 10 ); // $ExpectError
	set10( new Uint8Array( [ 1, 2, 3, 4 ] ), false, 10 ); // $ExpectError
	set10( new Uint8Array( [ 1, 2, 3, 4 ] ), null, 10 ); // $ExpectError
	set10( new Uint8Array( [ 1, 2, 3, 4 ] ), {}, 10 ); // $ExpectError

	const set11 = resolveSetter( new Uint8ClampedArray( 0 ) );
	set11( new Uint8ClampedArray( [ 1, 2, 3, 4 ] ), '5', 10 ); // $ExpectError
	set11( new Uint8ClampedArray( [ 1, 2, 3, 4 ] ), true, 10 ); // $ExpectError
	set11( new Uint8ClampedArray( [ 1, 2, 3, 4 ] ), false, 10 ); // $ExpectError
	set11( new Uint8ClampedArray( [ 1, 2, 3, 4 ] ), null, 10 ); // $ExpectError
	set11( new Uint8ClampedArray( [ 1, 2, 3, 4 ] ), {}, 10 ); // $ExpectError

	const set12 = resolveSetter( new Complex128Array( 0 ) );
	set12( new Complex128Array( [ 1, 2, 3, 4 ] ), '5', new Complex128( 0, 0 ) ); // $ExpectError
	set12( new Complex128Array( [ 1, 2, 3, 4 ] ), true, new Complex128( 0, 0 ) ); // $ExpectError
	set12( new Complex128Array( [ 1, 2, 3, 4 ] ), false, new Complex128( 0, 0 ) ); // $ExpectError
	set12( new Complex128Array( [ 1, 2, 3, 4 ] ), null, new Complex128( 0, 0 ) ); // $ExpectError
	set12( new Complex128Array( [ 1, 2, 3, 4 ] ), {}, new Complex128( 0, 0 ) ); // $ExpectError

	const set13 = resolveSetter( new Complex64Array( 0 ) );
	set13( new Complex64Array( [ 1, 2, 3, 4 ] ), '5', new Complex64( 0, 0 ) ); // $ExpectError
	set13( new Complex64Array( [ 1, 2, 3, 4 ] ), true, new Complex64( 0, 0 ) ); // $ExpectError
	set13( new Complex64Array( [ 1, 2, 3, 4 ] ), false, new Complex64( 0, 0 ) ); // $ExpectError
	set13( new Complex64Array( [ 1, 2, 3, 4 ] ), null, new Complex64( 0, 0 ) ); // $ExpectError
	set13( new Complex64Array( [ 1, 2, 3, 4 ] ), {}, new Complex64( 0, 0 ) ); // $ExpectError

	const set14 = resolveSetter( new AccessorArray( [ 1, 2, 3, 4 ] ) );
	set14( new AccessorArray( [ 1, 2, 3, 4 ] ), '5', 10 ); // $ExpectError
	set14( new AccessorArray( [ 1, 2, 3, 4 ] ), true, 10 ); // $ExpectError
	set14( new AccessorArray( [ 1, 2, 3, 4 ] ), false, 10 ); // $ExpectError
	set14( new AccessorArray( [ 1, 2, 3, 4 ] ), null, 10 ); // $ExpectError
	set14( new AccessorArray( [ 1, 2, 3, 4 ] ), {}, 10 ); // $ExpectError
}
...
// The compiler throws an error if the returned function is provided a third argument which is not a valid value...
{
	...
	const set12 = resolveSetter( new Complex128Array( 0 ) );
	set12( new Complex128Array( [ 1, 2, 3, 4 ] ), 2, '5' ); // $ExpectError
	set12( new Complex128Array( [ 1, 2, 3, 4 ] ), 2, true ); // $ExpectError
	set12( new Complex128Array( [ 1, 2, 3, 4 ] ), 2, false ); // $ExpectError
	set12( new Complex128Array( [ 1, 2, 3, 4 ] ), 2, null ); // $ExpectError
	set12( new Complex128Array( [ 1, 2, 3, 4 ] ), 2, {} ); // $ExpectError

	const set13 = resolveSetter( new Complex64Array( 0 ) );
	set13( new Complex64Array( [ 1, 2, 3, 4 ] ), 2, '5' ); // $ExpectError
	set13( new Complex64Array( [ 1, 2, 3, 4 ] ), 2, true ); // $ExpectError
	set13( new Complex64Array( [ 1, 2, 3, 4 ] ), 2, false ); // $ExpectError
	set13( new Complex64Array( [ 1, 2, 3, 4 ] ), 2, null ); // $ExpectError
	set13( new Complex64Array( [ 1, 2, 3, 4 ] ), 2, {} ); // $ExpectError

	const set14 = resolveSetter( new AccessorArray( [ 1, 2, 3, 4 ] ) );
	set14( new AccessorArray( [ 1, 2, 3, 4 ] ), 2, '5' ); // $ExpectError
	set14( new AccessorArray( [ 1, 2, 3, 4 ] ), 2, true ); // $ExpectError
	set14( new AccessorArray( [ 1, 2, 3, 4 ] ), 2, false ); // $ExpectError
	set14( new AccessorArray( [ 1, 2, 3, 4 ] ), 2, null ); // $ExpectError
	set14( new AccessorArray( [ 1, 2, 3, 4 ] ), 2, {} ); // $ExpectError
}
...
// The compiler throws an error if the returned function is provided an unsupported number of arguments...
{
	...
	set4( new Float16Array( [] ), 1, 2, 10 ); // $ExpectError

	const set5 = resolveSetter( new Int32Array( 0 ) );
	set5(); // $ExpectError
	set5( new Int32Array( [] ) ); // $ExpectError
	set5( new Int32Array( [] ), 1, 2, 10 ); // $ExpectError

	const set6 = resolveSetter( new Int16Array( 0 ) );
	set6(); // $ExpectError
	set6( new Int16Array( [] ) ); // $ExpectError
	set6( new Int16Array( [] ), 1, 2, 10 ); // $ExpectError

	const set7 = resolveSetter( new Int8Array( 0 ) );
	set7(); // $ExpectError
	set7( new Int8Array( [] ) ); // $ExpectError
	set7( new Int8Array( [] ), 1, 2, 10 ); // $ExpectError

	const set8 = resolveSetter( new Uint32Array( 0 ) );
	set8(); // $ExpectError
	set8( new Uint32Array( [] ) ); // $ExpectError
	set8( new Uint32Array( [] ), 1, 2, 10 ); // $ExpectError

	const set9 = resolveSetter( new Uint16Array( 0 ) );
	set9(); // $ExpectError
	set9( new Uint16Array( [] ) ); // $ExpectError
	set9( new Uint16Array( [] ), 1, 2, 10 ); // $ExpectError

	const set10 = resolveSetter( new Uint8Array( 0 ) );
	set10(); // $ExpectError
	set10( new Uint8Array( [] ) ); // $ExpectError
	set10( new Uint8Array( [] ), 1, 2, 10 ); // $ExpectError

	const set11 = resolveSetter( new Uint8ClampedArray( 0 ) );
	set11(); // $ExpectError
	set11( new Uint8ClampedArray( [] ) ); // $ExpectError
	set11( new Uint8ClampedArray( [] ), 1, 2, 10 ); // $ExpectError

	const set12 = resolveSetter( new Complex128Array( 0 ) );
	set12(); // $ExpectError
	set12( new Complex128Array( 0 ) ); // $ExpectError
	set12( new Complex128Array( 0 ), 1, new Complex128( 0, 0 ), 10 ); // $ExpectError

	const set13 = resolveSetter( new Complex64Array( 0 ) );
	set13(); // $ExpectError
	set13( new Complex64Array( 0 ) ); // $ExpectError
	set13( new Complex64Array( 0 ), 1, new Complex64( 0, 0 ), 10 ); // $ExpectError

	const set14 = resolveSetter( new AccessorArray( [ 1, 2, 3, 4 ] ) );
	set14(); // $ExpectError
	set14( new AccessorArray( [ 1, 2, 3, 4 ] ) ); // $ExpectError
	set14( new AccessorArray( [ 1, 2, 3, 4 ] ), 1, 2, 10 ); // $ExpectError
}
